...
const int kBIKbID = 1112099682; // not supported
const int kBIKfID = 1112099686;
const int kBIKgID = 1112099687;
const int kBIKhID = 1112099688;
const int kBIKiID = 1112099689;
